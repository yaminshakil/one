        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('admin.option.create',$option->control_id) }}" class='form-horizontal'>
                        {{ csrf_field() }}
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-9'>
                            <input class='form-control' type='text' id='name' name='name' placeholder='Value' value='{{ old('name') }}' required>
                          </div>
                        </div>
                        <div class='form-group'>
                          <label for='order' class='col-sm-3'>Order</label>
                          <div class='col-sm-2'>
                            <input class='form-control' type='number' id='order' name='order' min="1" max="50" step="1" value='{{ old('order')||1 }}' required>
                          </div>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-2'>
                            <input class='form-control' type='number' id='risk' name='risk' min="0" max="10" step="1" value='{{ old('risk') }}'>
                          </div>
                          <div class='col-sm-7 text-left'>
