    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Edit Company:</strong> {{ $section->name }}</div>

                <div class="panel-body">
                    <form method="POST" action="{{ route('admin.section.update',$section->id) }}" class='form-horizontal'>
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
