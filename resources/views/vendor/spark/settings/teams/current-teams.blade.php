    ...
    <div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-borderless m-b-none">
                    ...
                    <tbody>
                        <tr v-for="team in teams">
                            <!-- Photo -->
                            <td>
                                <a :href="'/{{str_plural(Spark::teamString())}}/'+team.id+'/switch'" title="Activate">
                ...
                <br/>
                <p>Click on an icon to switch your current assessment. Click 'Dashboard' to view the active assessment.</p>
            </div>
        </div>
