<form class="form-horizontal" role="form">
    ...
    <!-- Company Name -->
    <div class="form-group" :class="{'has-error': registerForm.errors.has('company')}">
        <label class="col-md-4 control-label">Company</label>

        <div class="col-md-6">
            <input type="text" class="form-control" name="company" v-model="registerForm.company" autofocus>
